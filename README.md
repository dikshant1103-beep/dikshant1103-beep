...
| **[moto_sim](https://github.com/dikshant1103-beep/moto-sim)** | PyChrono motorcycle simulator — tire PINNs, ROS2/Gazebo digital twin, validated against the Whipple benchmark to 0.02% | Python | Sep 2026 |
...
<sub>Table regenerated from the GitHub API — last run 07 Sep 2026.</sub>
<!-- WORK:END -->
