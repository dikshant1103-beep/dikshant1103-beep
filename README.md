...
|---|---|---|---|
| **[Chassis Workbench](https://github.com/dikshant1103-beep/chassis-workbench)** · [live](https://chassis-workbench.vercel.app) | Motorcycle chassis and suspension design — geometry, kinematics, multibody dynamics with a generalized-α solver, structural concept lane | TypeScript | Jul 2026 |
| **[moto_sim](https://github.com/dikshant1103-beep/moto-sim)** | PyChrono motorcycle simulator — tire PINNs, ROS2/Gazebo digital twin, validated against the Whipple benchmark to 0.02% | Python | Jul 2026 |
...
<sub>Table regenerated from the GitHub API — last run 27 Jul 2026.</sub>
<!-- WORK:END -->
